...
class Group {
    ...
    const DEFAULT_CHECKBOX_ACTIVE_BG = '#67bf3d';
    const DEFAULT_CHECKBOX_ACTIVE_BORDER_COLOR = '#60b239';
    ...
    const DEFAULT_GROUP_BORDER_RADIUS = 3;
