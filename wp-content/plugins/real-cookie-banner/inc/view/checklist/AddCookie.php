...
class AddCookie extends \DevOwl\RealCookieBanner\view\checklist\AbstractChecklistItem {
    ...
    public function getTitle() {
        return __('Add all cookies to your website', RCB_TD);
    }
    // Documented in AbstractChecklistItem
    public function getDescription() {
        return __(
            'You can manually add all cookies from your website. Use the cookie templates of known services to save time!',
            RCB_TD
        );
    }
    // Documented in AbstractChecklistItem
