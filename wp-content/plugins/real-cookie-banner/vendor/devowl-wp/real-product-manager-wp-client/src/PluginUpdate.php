...
class PluginUpdate {
    ...
    protected function getPotentialBlogIds() {
        $needsPerMu = $this->getInitiator()->isMultisiteLicensed();
        $isMu = \function_exists('switch_to_blog') && \function_exists('get_network') && get_network() !== null;
