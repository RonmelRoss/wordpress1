...
class UpdateNotice {
    ...
    protected function outputNotice($needsUpdate) {
        ...
        echo '<div class="notice notice-warning"><p>' .
            __(
                'It seems that since the last update of <strong>Real Cookies Banner</strong> some templates have been updated. Please check your following cookies to make sure they are up to date:',
                RCB_TD
            ) .
            '</p><ul>';
        foreach ($needsUpdate as $update) {
