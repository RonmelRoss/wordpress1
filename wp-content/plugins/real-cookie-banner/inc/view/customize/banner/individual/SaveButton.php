...
class SaveButton {
    ...
    const DEFAULT_PADDING = [5, 5, 5, 5];
    const DEFAULT_BG = '#ffffff';
    const DEFAULT_TEXT_ALIGN = 'center';
    const DEFAULT_FONT_SIZE = 14;
    const DEFAULT_FONT_COLOR = '#60b239';
    ...
    const DEFAULT_BORDER_COLOR = '#60b239';
    const DEFAULT_HOVER_BG = '#ffffff';
    const DEFAULT_HOVER_BORDER_COLOR = '#59a535';
    const DEFAULT_HOVER_FONT_COLOR = '#59a535';
    /**
