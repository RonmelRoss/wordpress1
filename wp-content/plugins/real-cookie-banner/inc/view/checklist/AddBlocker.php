...
class AddBlocker extends \DevOwl\RealCookieBanner\view\checklist\AbstractChecklistItem {
    ...
    public function getDescription() {
        return __(
            'For visitors who do not agree to the cookies from e. g. YouTube, it is not allowed to load YouTube videos on your website. Content Blockers will automatically replace this content and ask again for the visitor\'s consent.',
            RCB_TD
        );
    }
    // Documented in AbstractChecklistItem
