...
class WooCommerceGoogleAnalyticsPreset extends \DevOwl\RealCookieBanner\presets\AbstractCookiePreset {
    ...
    const SLUG_FREE = 'woocommerce-google-analytics-integration';
    const SLUG_PRO = 'woocommerce-google-analytics-pro';
    ...
    public static function isPluginActive() {
        return \DevOwl\RealCookieBanner\Utils::anyPluginActive([self::SLUG_FREE, self::SLUG_PRO]);
    }
}
