 ...
 * Description: 	Obtain GDPR (DSGVO) and ePrivacy (EU cookie law) compliant opt-in cookie consent. Find cookies and fill all legal information in your cookie banner. More than just a cookie notice!
 * Author:          devowl.io
...
define('RCB_MIN_PHP', '7.0.0'); // Minimum of PHP 5.3 required for autoloading and namespacing
