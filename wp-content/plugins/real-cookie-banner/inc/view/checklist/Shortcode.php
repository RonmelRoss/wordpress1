...
class Shortcode extends \DevOwl\RealCookieBanner\view\checklist\AbstractChecklistItem {
    ...
    public function getDescription() {
        return __(
            'Your visitors must be able to view, change and revoke their cookie consent at any time. You should add shortcodes to your privacy policy to provide this feature.',
            RCB_TD
        );
    }
    // Documented in AbstractChecklistItem
