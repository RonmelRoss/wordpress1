...
class Texts {
        ...
        return [
            ...
            'controls' => [
                ...
                self::SETTING_SHOW_MORE => [
                    'name' => 'showMore',
                    'label' => __('"Show cookie information" link', RCB_TD),
                    'setting' => ['default' => $defaultButtonTexts['showMore']]
                ],
                self::SETTING_HIDE_MORE => [
                    'name' => 'hideMore',
                    'label' => __('"Hide cookie information" link', RCB_TD),
    ...
    public static function getDefaultButtonTexts() {
        ...
        $defaults = [
            ...
            'showMore' => __('Show cookie information', \DevOwl\RealCookieBanner\comp\language\Hooks::TD_FORCED),
            'hideMore' => __('Hide cookie information', \DevOwl\RealCookieBanner\comp\language\Hooks::TD_FORCED)
        ];
        $tempTd->teardown();
        return $defaults;
    }
