...
class Design {
    ...
    const DEFAULT_FONT_INHERIT_FAMILY = \false;
    ...
    const DEFAULT_BOX_SHADOW_OFFSET_Y = -1;
    const DEFAULT_BOX_SHADOW_BLUR_RADIUS = 9;
    const DEFAULT_BOX_SHADOW_SPREAD_RADIUS = 0;
    const DEFAULT_BOX_SHADOW_COLOR = '#2b2b2b';
    /**
        ...
        return [
            ...
            'controls' => [
                ...
                self::SETTING_FONT_INHERIT_FAMILY => [
                    ...
                    'label' => __('Inherit font family from theme', RCB_TD),
                    'type' => 'checkbox',
                    'setting' => [
