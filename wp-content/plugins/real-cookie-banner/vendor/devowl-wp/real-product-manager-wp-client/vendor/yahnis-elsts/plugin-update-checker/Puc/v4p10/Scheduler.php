...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p10_Scheduler', \false)) {
    /**
    ...
    class Puc_v4p10_Scheduler {
        ...
        public function upgraderProcessComplete(
            ...
            if (\is_a($this->updateChecker, 'DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p10_Theme_UpdateChecker')) {
            ...
            if (\is_a($this->updateChecker, 'DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p10_Plugin_UpdateChecker')) {
