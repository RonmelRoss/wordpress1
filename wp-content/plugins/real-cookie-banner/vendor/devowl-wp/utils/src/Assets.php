...
JS;
    ...
    /**
     * Make a localized array anonymous instead of using plain JSON. Some plugins like
     * WP Rocket tries to lazy load also localized scripts and this should be avoided in some
     * scenarios like Real Cookie Banners' banner script. Use this instead of `wp_localize_script`.
     *
