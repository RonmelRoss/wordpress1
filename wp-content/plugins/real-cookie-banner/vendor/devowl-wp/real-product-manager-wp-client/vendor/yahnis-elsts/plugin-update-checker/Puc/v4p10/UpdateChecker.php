...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p10_UpdateChecker', \false)) {
    abstract class Puc_v4p10_UpdateChecker {
        ...
        public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '') {
            ...
            $this->upgraderStatus = new \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_UpgraderStatus();
            $this->updateState = new \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_StateStore($this->optionName);
            if (\did_action('init')) {
                $this->loadTextDomain();
            } else {
        ...
        protected function fixSupportedWordpressVersion(
            \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_Metadata $update = null
        ) {
        ...
        protected function createDebugBarExtension() {
            return new \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_DebugBar_Extension($this);
        }
        /**
