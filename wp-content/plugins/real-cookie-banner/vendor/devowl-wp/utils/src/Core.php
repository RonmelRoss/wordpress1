...
trait Core {
    ...
    protected function construct() {
        ...
        $this->activator = $this->getPluginClassInstance(
            \DevOwl\RealCookieBanner\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CLASS_ACTIVATOR
        );
        $this->assets = $this->getPluginClassInstance(
            \DevOwl\RealCookieBanner\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CLASS_ASSETS
        );
    ...
    public function updateDbCheck() {
        $installed = get_option(
            $this->getPluginConstant(
                \DevOwl\RealCookieBanner\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_OPT_PREFIX
            ) . '_db_version'
        );
        if (
            $installed !==
