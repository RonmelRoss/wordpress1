...
class Core {
    ...
    private function __construct() {
        \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\UtilsProvider::setupConstants();
        ...
        $options = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealUtils\view\Options::instance();
