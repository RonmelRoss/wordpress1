...
class Config {
    ...
    public function routeGetRevisionCurrent() {
        return new \WP_REST_Response(\DevOwl\RealCookieBanner\settings\Revision::getInstance()->getCurrent());
    }
    /**
     * See API docs.
     *
    ...
    public function routeGetRevisionByHash($request) {
        $result = \DevOwl\RealCookieBanner\settings\Revision::getInstance()->getByHash($request->get_param('hash'));
        return $result === null
     ...
     * See API docs.
     *
     * @api {get} /real-cookie-banner/v1/cookies/unassigned Get unassigned cookies
     * @apiHeader {string} X-WP-Nonce
