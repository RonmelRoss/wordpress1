...
class Consent implements \DevOwl\RealCookieBanner\overrides\interfce\settings\IOverrideConsent {
    ...
    // const SETTING_ONLY_EU_COOKIE_BANNER = RCB_OPT_PREFIX . '-only-eu-cookie-banner';
    ...
    const DEFAULT_RESPECT_DO_NOT_TRACK = \true;
    // const DEFAULT_ONLY_EU_COOKIE_BANNER = false;
