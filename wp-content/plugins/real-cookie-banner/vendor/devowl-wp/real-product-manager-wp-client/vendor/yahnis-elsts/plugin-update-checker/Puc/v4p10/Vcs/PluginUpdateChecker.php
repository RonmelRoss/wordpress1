...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p10_Vcs_PluginUpdateChecker')) {
    class Puc_v4p10_Vcs_PluginUpdateChecker
        extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_Plugin_UpdateChecker
        ...
        public function requestInfo($unusedParameter = null) {
            ...
            $info = new \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_Plugin_Info();
