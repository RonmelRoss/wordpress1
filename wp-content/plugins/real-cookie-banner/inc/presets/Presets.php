...
abstract class Presets {
     ...
     * @param array $row
     */
    protected function castReadRow(&$row) {
    ...
    public function persist($items) {
        ...
        $result = $wpdb->query(
            \sprintf(
                'INSERT INTO %s (`type`, `identifier`, `context`, `version`, `description`, `logoFile`, `name`, `tags`, `attributes_name`, `disabled`, `hidden`, `other_meta`)
