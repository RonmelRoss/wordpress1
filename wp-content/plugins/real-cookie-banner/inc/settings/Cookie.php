...
class Cookie {
    ...
    const SYNC_OPTIONS = [
        ...
        'meta' => [
            'copy' => \DevOwl\RealCookieBanner\settings\Cookie::SYNC_META_COPY_AND_COPY_ONCE,
            'copy-once' => \DevOwl\RealCookieBanner\settings\Cookie::SYNC_META_COPY_AND_COPY_ONCE
        ]
    ];
    const META_KEYS = [
        \DevOwl\RealCookieBanner\settings\Cookie::META_NAME_PROVIDER,
    ...
    /**
     * Get unassigned cookies (cookies without cookie group).
     */
