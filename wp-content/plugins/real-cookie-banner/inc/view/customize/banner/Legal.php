...
class Legal {
    ...
    public function args() {
        ...
        return [
            ...
            'description' => __(
                'In order to comply with the ePrivacy Directive, it is important that the cookie banner/dialog contains a direct link to the privacy policy and the imprint (if required in your country).',
                RCB_TD
            ),
            'controls' => [
                ...
                self::SETTING_PRIVACY_POLICY_HIDE => [
                    ...
                    'description' => __(
                        'According to some data protectors, it must be ensured that the privacy policy can be viewed before accepting cookies.',
                        RCB_TD
                    ),
                    'type' => 'checkbox',
                    'setting' => [
                ...
                self::SETTING_IMPRINT_HIDE => [
                    ...
                    'description' => __(
                        'According to some data protectors, it must be ensured that the imprint can be viewed before accepting cookies.',
                        RCB_TD
                    ),
                    'type' => 'checkbox',
                    'setting' => [
