...
if (!\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Puc_v4p10_Plugin_UpdateChecker', \false)) {
    /**
     ...
     * @access public
     */
    class Puc_v4p10_Plugin_UpdateChecker extends \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_UpdateChecker {
        ...
        public function __construct(
            ...
            $this->extraUi = new \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_Plugin_Ui($this);
        }
        /**
        ...
        protected function createScheduler($checkPeriod) {
            $scheduler = new \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_Scheduler($this, $checkPeriod, [
                'load-plugins.php'
            ]);
        ...
        public function requestUpdate() {
            ...
            $update = \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_Plugin_Update::fromPluginInfo($pluginInfo);
        ...
        protected function createDebugBarExtension() {
            return new \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_DebugBar_PluginExtension($this);
        }
        /**
        ...
        protected function createInstalledPackage() {
            return new \DevOwl\RealCookieBanner\Vendor\Puc_v4p10_Plugin_Package($this->pluginAbsolutePath, $this);
        }
        /**
